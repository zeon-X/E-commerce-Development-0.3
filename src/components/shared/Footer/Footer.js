            ...
            <div className='footer-content'>
                ...
                <div className='footer-card-content'>
                    ...
                    <div className='footer-card-group footer-card-content-allehaTechIntro mx-10'>
                        <p className='text-xl mb-8'>Weeding Art by ZEON-X</p>
                        <p style={{ color: "grey" }}>
                            We have experienced makeover artist who is not only an expert to make a bride looks beautiful 
                        </p>
                        ...
                        <div className='footer-card-content-service mx-8'>
                            ...
                            <div style={{ color: "grey" }}>
                                <div className='footer-card-content-singleLink flex'>
                                    ...
                                    <Link to='/service/ss'>Regular_Packge_1</Link>
                                </div>
                                <div className='footer-card-content-singleLink flex'>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 " fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                    </svg>
                                    <Link to='/service/as'>Regular_Packge_2</Link>
                                </div>
                                <div className='footer-card-content-singleLink flex'>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 " fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                    </svg>
                                    <Link to='/service/c'>Standard_Packge_1</Link>
                                </div>
                                <div className='footer-card-content-singleLink flex'>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 " fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                    </svg>
                                    <Link to='/service/uiux'>Standard_Packge_2</Link>
                                </div>
                                <div className='footer-card-content-singleLink flex'>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 " fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                    </svg>
                                    <Link to='/service/ma'>Premium_Packge_1</Link>
                                </div>
                                <div className='footer-card-content-singleLink flex'>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 " fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                    </svg>
                                    <Link to='/service/sqa'>Premium_Packge_2</Link>
                                </div>
                ...
                <p style={{
                    fontSize: "12px", letterSpacing: "2px", marginTop: "100px", textAlign: "center"
                }}>Copyright ©{year} All rights reserved | Weeding Art by ZEONX.
                </p>
